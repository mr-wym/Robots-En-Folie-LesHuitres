...
def envoyerMission():
    ...
    preparationEnvoieMission(MissionEntry(), selected_alias.get(), labelResultRequest2, updateDropdown)
...
# champRobotId.bind("<KeyRelease>", lambda event: formatMac(event, champRobotId))
